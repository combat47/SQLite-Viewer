...
public class SQLiteViewer extends JFrame {
    ...
    public SQLiteViewer() {
        ...
        tablesComboBox.setBounds(75, 50, 590, 30);
        add(tablesComboBox);
